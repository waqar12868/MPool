...
import os
import json
from MPool.train import train, evaluate, train_regression, evaluate_regression
from MPool.mpool import MPool
from MPool.params import get_params
...
parser.add_argument('--dataset', type=str, default='Mutagenicity',
                    choices=['Mutagenicity', 'REDDIT-BINARY', 'PROTEINS', 'NCI109', 'NCI1', 'IMDB-BINARY', 'DD', 'COLLAB'])
...
model = MPool(num_features=stats['num_features'], num_classes=stats['num_classes'],
